      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col justify-center">
            ...
            <a href="#Contact"
	        className="group relative inline-block overflow-hidden rounded border border-gray-100 bg-gray-200  px-12 py-3 text-2xl text-center font-[Monospace] text-slate-800 hover:text-teal-600 focus:outline-none focus:ring active:bg-indigo-600 active:text-white">
